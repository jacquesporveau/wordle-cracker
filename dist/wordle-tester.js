...
export class WordleTester {
    ...
    displayResults({ results, failed, }) {
        const average = results.reduce((sum, guesses) => sum + guesses, 0) / results.length;
...
//# sourceMappingURL=wordle-tester.js.map